...
public class EndlessTree : MonoBehaviour
{
    ...
    void SpawnPlatform()
    {
        ...
        float gap = Random.Range(20f, 50f); // Platformlar arasındaki rastgele boşluk
        ...
        Instantiate(selectedPlatformPrefab, new Vector3(lastPlatformPositionX, -3f, 0), Quaternion.identity);
    }
}
